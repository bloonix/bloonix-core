# THIS IS JUST A COPY OF THE REAL IPC::Open3 VERSION 1.09 FROM
# PERL 5.14. THE REASON IS THAT IPC::Open3 FROM PERL 5.8.8 GOT
# A BUG AND IS NOT UPGRADEABLE.

package Bloonix::IPC::Open3;
